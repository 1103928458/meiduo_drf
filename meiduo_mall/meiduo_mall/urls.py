...
urlpatterns = [
    ...
    url(r'^', include("oauth.url",namespace="oauth")),  #QQ登录模块

    url(r'^', include("areas.urls",namespace="areas")),  #区域省市模块

    url(r'^', include("goods.urls",namespace="goods")),  #商品列表界面模块

    url(r'^', include("carts.urls",namespace="carts")),  #购物车模块

    url(r'^', include("orders.urls",namespace="orders")),  #订单结算模块
